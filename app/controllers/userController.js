...
module.exports = {
    ...
    getDashboard: async (req, res) => {
        ...
        if (req.method == 'GET') {
            ...
            let { email, first_name, middle_name, last_name, address, city, state, zip, 
              age, blood_group, vaccination_certificate_id, vaccination_certificate_date,
              first_vaccination_city, second_vaccination_city } = { ...req.user }

            let loginUser = { email, first_name, middle_name, last_name, address, city, state, zip,
               age, blood_group, vaccination_certificate_id, vaccination_certificate_date,
                first_vaccination_city, second_vaccination_city }
